...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { book_id: @lineitem.book_id, cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, quantity: @lineitem.quantity }
    end
  ...
  test "should update lineitem" do
    put :update, id: @lineitem, lineitem: { book_id: @lineitem.book_id, cart_id: @lineitem.cart_id, order_id: @lineitem.order_id, quantity: @lineitem.quantity }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
